...
<?php
    ...
    $message = '<html><body>';
		...
		$message .= 'Dear John, <br><br>Dr. Admin has ordered a measurement for you: <b>';
		$message .= $formName;
		$message .= '</b><br><b>Your measurement will close after ';
		$message .= $expiration;
		$message .= ' ,</b> so please log in and complete it before then.';
		$message .= '<center>Go to EasiPro at: http://128.163.202.60/openemr/patients</center><br>If you need help or have any questions, please call us toll free at 859.218.4962 or email us at easipro@uky.edu.<br>Thanks,<br>EasiPRO Team';
